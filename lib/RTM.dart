...
import 'package:shengwang_demo/Agora.dart';

class RTMPage extends StatefulWidget {
  const RTMPage({Key? key}) : super(key: key);

  @override
  RTMPageState createState() => RTMPageState();
}

class RTMPageState extends State<RTMPage> {
  bool _isLogin = false;
  ...
  void _createClient() async {
    ...
    /*
    * 1、对于iOS，logFilepath为空字符串时，则无法接受消息；为可用路径时，可正常接受消息
    * 2、对于Android，logFilepath为空字符串，或者为可用路径时，都可以正常接受消息
